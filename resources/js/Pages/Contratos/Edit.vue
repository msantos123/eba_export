...
const form = useForm({
    ...
    ctrt_precio_html: contenido.ctrt_precio_html,
    ...
    ctrt_pago_html: contenido.ctrt_pago_html,
...
const submitForm = (status) => {
    form.status = status;
    form.put(route('contratos.update'), {
    });
}
</script>
<style scoped>
        ...
        <div class="mb-4 inline-flex w-full overflow-hidden rounded-lg bg-white shadow-md">
            <div class="px-4 py-3 flex">
                ...
                <div class="mx-1">
                    ...
                    <i class="fa-solid fa-floppy-disk" style="color: #ffffff;"></i> Guardar Borrador
                    </BorradorButton>
                </div>
                <div class="mx-1">
                    <GreenButton :disabled="form.processing" @click.prevent="submitForm(1)">
                    <i class="fa-solid fa-floppy-disk" style="color: #ffffff;"></i> Guardar y Terminar
                    </GreenButton>
                </div>
            </div>
        </div>
                        ...
                        <form>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div>
                                    ...
                                    <TextInput type="text" required class="mt-2 block w-full"
