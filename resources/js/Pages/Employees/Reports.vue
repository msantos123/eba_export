...
buttons1.value = [
    ...
    },
    {
        ...
        text:'<i class="fa-solid fa-file-print"></i> PDF',
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="report == '2'" class="px-6 py-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <tbody>
                        <tr v-for="dep, i in departments.data" :key="dep.id">
                            ...
                            <td class="border border-gray-400 px-2 py-2">{{ dep.name }}</td>
                        </tr>
                    </tbody>
                    </DataTable>
                </div>
                <div>
                    <p>Departments: {{ props.departments }}</p>
